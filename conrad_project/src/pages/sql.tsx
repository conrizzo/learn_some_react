        ...
        <div className={styles.centering}>
            <div className={styles['set-width']}>
                ...
                <p>June, 28 2024 - This page connects to a <a className='link' href="https://turso.tech/">Turso</a> database.
                    ...
                    how to/best practices to connect to backend data with React / Next.js.
                    I've already learned the basics of how to use backend commands on Vue.js with my self made Flask backend querying PostgreSQL.
